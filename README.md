...
Welcome to the **Billin code challenge 2021 edition**. We look forward to seeing what you come up with!!
...
We have given you with the two CSV files you will need to get the tests running in. Please see the `files` folder.
